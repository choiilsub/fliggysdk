...
class TaobaoXhotelRatesLiteIncrUpdateRequest {
     ...
     **/
    private $rateListInvInfo;


    public function getRateListInvInfo() : string{
        return $this->rateListInvInfo;
    }

    public function setRateListInvInfo(string $rateListInvInfo){
        $this->rateListInvInfo = $rateListInvInfo;
    }
    ...
    public function toMap() : array{
        $requestParam = array();
        if (!TopUtil::checkEmpty($this->rateListInvInfo)) {
            $requestParam["rate_list_inv_info"] = TopUtil::convertBasic($this->rateListInvInfo);
        }
