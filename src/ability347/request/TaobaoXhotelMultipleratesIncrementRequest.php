...
class TaobaoXhotelMultipleratesIncrementRequest {
    ...
    public function getRateQuotaMap() : string{
        return $this->rateQuotaMap;
    }

    public function setRateQuotaMap(string $rateQuotaMap){
    ...
    public function toMap() : array{
        $requestParam = array();
        if (!TopUtil::checkEmpty($this->rateQuotaMap)) {
            $requestParam["rate_quota_map"] = TopUtil::convertBasic($this->rateQuotaMap);
        }
