...
class TaobaoXhotelRoomtypeUpdateXRoomType {
    ...
    public function getSRoomtype() : TaobaoXhotelRoomtypeUpdateSRoomType{
        return $this->s_roomtype;
    }

    public function setSRoomtype(TaobaoXhotelRoomtypeUpdateSRoomType $sRoomtype){
