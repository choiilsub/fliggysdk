...
class TaobaoXhotelRoomtypeGetXRoomType {
    ...
    public function getSRoomtype() : TaobaoXhotelRoomtypeGetSRoomType{
        return $this->s_roomtype;
    }

    public function setSRoomtype(TaobaoXhotelRoomtypeGetSRoomType $sRoomtype){
